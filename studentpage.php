...
<head>
    ...
    <title>Student Page -  Celestial Scholar University Student Portal</title>
    ...
    if (!function_exists('buildTable')) {
        function buildTable($result) {
            if(mysqli_num_rows($result) > 0) {
                echo "<table>";
                echo "<tr>";
                echo "<th>Student number</th> <th>Fullname</th><th>Course</th> <th>Year Level</th> <th>Date Created </th> <th>Action</th>";
                echo "</tr>";
                echo "<br>";
                while ($row = mysqli_fetch_array($result)) {
                    echo "<tr>";
                    echo "<td><strong>" . $row['studentnumber'] . "</strong></td>";
                    echo "<td><strong>" . $row['lastname'] .'&nbsp'. $row['firstname'].'&nbsp' . $row['middlename'] . "</td></strong>";
                    echo "<td><strong>" . $row['course'] . "</td></strong>";
                    echo "<td><strong>" . $row['yearlevel'] . "</td></strong>";
                    echo "<td><strong>" . $row['datecreated'] . "</td></strong>";
                    echo "<td>";
                    echo "<a href='studupdate.php?studentnumber=" . $row['studentnumber'] . "' class='btnupdate'><strong>Update</strong></a>'"; 
                    echo "<button onclick='openDeleteModal(\"" . $row['studentnumber'] . "\")' class='btndelete'><strong>Delete</strong></button>";
                    echo "</td>";
                    echo "</tr>";
                }
                echo "</table>";
